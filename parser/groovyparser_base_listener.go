...
func (s *BaseGroovyParserListener) EnterCompactConstructorDeclaration(ctx *CompactConstructorDeclarationContext) {
}

// ExitCompactConstructorDeclaration is called when production compactConstructorDeclaration is exited.
func (s *BaseGroovyParserListener) ExitCompactConstructorDeclaration(ctx *CompactConstructorDeclarationContext) {
}
...
// EnterEmptyDims is called when production emptyDims is entered.
func (s *BaseGroovyParserListener) EnterEmptyDims(ctx *EmptyDimsContext) {}

// ExitEmptyDims is called when production emptyDims is exited.
func (s *BaseGroovyParserListener) ExitEmptyDims(ctx *EmptyDimsContext) {}

// EnterEmptyDimsOpt is called when production emptyDimsOpt is entered.
func (s *BaseGroovyParserListener) EnterEmptyDimsOpt(ctx *EmptyDimsOptContext) {}

// ExitEmptyDimsOpt is called when production emptyDimsOpt is exited.
func (s *BaseGroovyParserListener) ExitEmptyDimsOpt(ctx *EmptyDimsOptContext) {}
...
func (s *BaseGroovyParserListener) EnterType(ctx *TypeContext) {}

// ExitType is called when production type is exited.
func (s *BaseGroovyParserListener) ExitType(ctx *TypeContext) {}
...
func (s *BaseGroovyParserListener) EnterYieldStatement(ctx *YieldStatementContext) {}

// ExitYieldStatement is called when production yieldStatement is exited.
func (s *BaseGroovyParserListener) ExitYieldStatement(ctx *YieldStatementContext) {}
...
// EnterYieldStmtAlt is called when production yieldStmtAlt is entered.
func (s *BaseGroovyParserListener) EnterYieldStmtAlt(ctx *YieldStmtAltContext) {}

// ExitYieldStmtAlt is called when production yieldStmtAlt is exited.
func (s *BaseGroovyParserListener) ExitYieldStmtAlt(ctx *YieldStmtAltContext) {}
...
func (s *BaseGroovyParserListener) EnterSwitchExpression(ctx *SwitchExpressionContext) {}

// ExitSwitchExpression is called when production switchExpression is exited.
func (s *BaseGroovyParserListener) ExitSwitchExpression(ctx *SwitchExpressionContext) {}

// EnterSwitchBlockStatementExpressionGroup is called when production switchBlockStatementExpressionGroup is entered.
func (s *BaseGroovyParserListener) EnterSwitchBlockStatementExpressionGroup(ctx *SwitchBlockStatementExpressionGroupContext) {
}

// ExitSwitchBlockStatementExpressionGroup is called when production switchBlockStatementExpressionGroup is exited.
func (s *BaseGroovyParserListener) ExitSwitchBlockStatementExpressionGroup(ctx *SwitchBlockStatementExpressionGroupContext) {
}

// EnterSwitchExpressionLabel is called when production switchExpressionLabel is entered.
func (s *BaseGroovyParserListener) EnterSwitchExpressionLabel(ctx *SwitchExpressionLabelContext) {}

// ExitSwitchExpressionLabel is called when production switchExpressionLabel is exited.
func (s *BaseGroovyParserListener) ExitSwitchExpressionLabel(ctx *SwitchExpressionLabelContext) {}
...
// EnterImplicationExprAlt is called when production implicationExprAlt is entered.
func (s *BaseGroovyParserListener) EnterImplicationExprAlt(ctx *ImplicationExprAltContext) {}

// ExitImplicationExprAlt is called when production implicationExprAlt is exited.
func (s *BaseGroovyParserListener) ExitImplicationExprAlt(ctx *ImplicationExprAltContext) {}
...
// EnterSwitchExprAlt is called when production switchExprAlt is entered.
func (s *BaseGroovyParserListener) EnterSwitchExprAlt(ctx *SwitchExprAltContext) {}

// ExitSwitchExprAlt is called when production switchExprAlt is exited.
func (s *BaseGroovyParserListener) ExitSwitchExprAlt(ctx *SwitchExprAltContext) {}
...
// EnterCastExprAltOperand is called when production castExprAltOperand is entered.
func (s *BaseGroovyParserListener) EnterCastExprAltOperand(ctx *CastExprAltOperandContext) {}

// ExitCastExprAltOperand is called when production castExprAltOperand is exited.
func (s *BaseGroovyParserListener) ExitCastExprAltOperand(ctx *CastExprAltOperandContext) {}

// EnterPostfixExprAltOperand is called when production postfixExprAltOperand is entered.
func (s *BaseGroovyParserListener) EnterPostfixExprAltOperand(ctx *PostfixExprAltOperandContext) {}

// ExitPostfixExprAltOperand is called when production postfixExprAltOperand is exited.
func (s *BaseGroovyParserListener) ExitPostfixExprAltOperand(ctx *PostfixExprAltOperandContext) {}

// EnterUnaryNotExprAltOperand is called when production unaryNotExprAltOperand is entered.
func (s *BaseGroovyParserListener) EnterUnaryNotExprAltOperand(ctx *UnaryNotExprAltOperandContext) {}

// ExitUnaryNotExprAltOperand is called when production unaryNotExprAltOperand is exited.
func (s *BaseGroovyParserListener) ExitUnaryNotExprAltOperand(ctx *UnaryNotExprAltOperandContext) {}

// EnterUnaryAddExprAltOperand is called when production unaryAddExprAltOperand is entered.
func (s *BaseGroovyParserListener) EnterUnaryAddExprAltOperand(ctx *UnaryAddExprAltOperandContext) {}

// ExitUnaryAddExprAltOperand is called when production unaryAddExprAltOperand is exited.
func (s *BaseGroovyParserListener) ExitUnaryAddExprAltOperand(ctx *UnaryAddExprAltOperandContext) {}
...
// EnterIdentifierPrmrAltNamedPropertyArgPrimary is called when production identifierPrmrAltNamedPropertyArgPrimary is entered.
func (s *BaseGroovyParserListener) EnterIdentifierPrmrAltNamedPropertyArgPrimary(ctx *IdentifierPrmrAltNamedPropertyArgPrimaryContext) {
}

// ExitIdentifierPrmrAltNamedPropertyArgPrimary is called when production identifierPrmrAltNamedPropertyArgPrimary is exited.
func (s *BaseGroovyParserListener) ExitIdentifierPrmrAltNamedPropertyArgPrimary(ctx *IdentifierPrmrAltNamedPropertyArgPrimaryContext) {
}

// EnterLiteralPrmrAltNamedPropertyArgPrimary is called when production literalPrmrAltNamedPropertyArgPrimary is entered.
func (s *BaseGroovyParserListener) EnterLiteralPrmrAltNamedPropertyArgPrimary(ctx *LiteralPrmrAltNamedPropertyArgPrimaryContext) {
}

// ExitLiteralPrmrAltNamedPropertyArgPrimary is called when production literalPrmrAltNamedPropertyArgPrimary is exited.
func (s *BaseGroovyParserListener) ExitLiteralPrmrAltNamedPropertyArgPrimary(ctx *LiteralPrmrAltNamedPropertyArgPrimaryContext) {
}

// EnterGstringPrmrAltNamedPropertyArgPrimary is called when production gstringPrmrAltNamedPropertyArgPrimary is entered.
func (s *BaseGroovyParserListener) EnterGstringPrmrAltNamedPropertyArgPrimary(ctx *GstringPrmrAltNamedPropertyArgPrimaryContext) {
}

// ExitGstringPrmrAltNamedPropertyArgPrimary is called when production gstringPrmrAltNamedPropertyArgPrimary is exited.
func (s *BaseGroovyParserListener) ExitGstringPrmrAltNamedPropertyArgPrimary(ctx *GstringPrmrAltNamedPropertyArgPrimaryContext) {
}

// EnterParenPrmrAltNamedPropertyArgPrimary is called when production parenPrmrAltNamedPropertyArgPrimary is entered.
func (s *BaseGroovyParserListener) EnterParenPrmrAltNamedPropertyArgPrimary(ctx *ParenPrmrAltNamedPropertyArgPrimaryContext) {
}

// ExitParenPrmrAltNamedPropertyArgPrimary is called when production parenPrmrAltNamedPropertyArgPrimary is exited.
func (s *BaseGroovyParserListener) ExitParenPrmrAltNamedPropertyArgPrimary(ctx *ParenPrmrAltNamedPropertyArgPrimaryContext) {
}

// EnterListPrmrAltNamedPropertyArgPrimary is called when production listPrmrAltNamedPropertyArgPrimary is entered.
func (s *BaseGroovyParserListener) EnterListPrmrAltNamedPropertyArgPrimary(ctx *ListPrmrAltNamedPropertyArgPrimaryContext) {
}

// ExitListPrmrAltNamedPropertyArgPrimary is called when production listPrmrAltNamedPropertyArgPrimary is exited.
func (s *BaseGroovyParserListener) ExitListPrmrAltNamedPropertyArgPrimary(ctx *ListPrmrAltNamedPropertyArgPrimaryContext) {
}

// EnterMapPrmrAltNamedPropertyArgPrimary is called when production mapPrmrAltNamedPropertyArgPrimary is entered.
func (s *BaseGroovyParserListener) EnterMapPrmrAltNamedPropertyArgPrimary(ctx *MapPrmrAltNamedPropertyArgPrimaryContext) {
}

// ExitMapPrmrAltNamedPropertyArgPrimary is called when production mapPrmrAltNamedPropertyArgPrimary is exited.
func (s *BaseGroovyParserListener) ExitMapPrmrAltNamedPropertyArgPrimary(ctx *MapPrmrAltNamedPropertyArgPrimaryContext) {
}

// EnterIdentifierPrmrAltNamedArgPrimary is called when production identifierPrmrAltNamedArgPrimary is entered.
func (s *BaseGroovyParserListener) EnterIdentifierPrmrAltNamedArgPrimary(ctx *IdentifierPrmrAltNamedArgPrimaryContext) {
}

// ExitIdentifierPrmrAltNamedArgPrimary is called when production identifierPrmrAltNamedArgPrimary is exited.
func (s *BaseGroovyParserListener) ExitIdentifierPrmrAltNamedArgPrimary(ctx *IdentifierPrmrAltNamedArgPrimaryContext) {
}

// EnterLiteralPrmrAltNamedArgPrimary is called when production literalPrmrAltNamedArgPrimary is entered.
func (s *BaseGroovyParserListener) EnterLiteralPrmrAltNamedArgPrimary(ctx *LiteralPrmrAltNamedArgPrimaryContext) {
}

// ExitLiteralPrmrAltNamedArgPrimary is called when production literalPrmrAltNamedArgPrimary is exited.
func (s *BaseGroovyParserListener) ExitLiteralPrmrAltNamedArgPrimary(ctx *LiteralPrmrAltNamedArgPrimaryContext) {
}

// EnterGstringPrmrAltNamedArgPrimary is called when production gstringPrmrAltNamedArgPrimary is entered.
func (s *BaseGroovyParserListener) EnterGstringPrmrAltNamedArgPrimary(ctx *GstringPrmrAltNamedArgPrimaryContext) {
}

// ExitGstringPrmrAltNamedArgPrimary is called when production gstringPrmrAltNamedArgPrimary is exited.
func (s *BaseGroovyParserListener) ExitGstringPrmrAltNamedArgPrimary(ctx *GstringPrmrAltNamedArgPrimaryContext) {
}

// EnterIdentifierPrmrAltCommandPrimary is called when production identifierPrmrAltCommandPrimary is entered.
func (s *BaseGroovyParserListener) EnterIdentifierPrmrAltCommandPrimary(ctx *IdentifierPrmrAltCommandPrimaryContext) {
}

// ExitIdentifierPrmrAltCommandPrimary is called when production identifierPrmrAltCommandPrimary is exited.
func (s *BaseGroovyParserListener) ExitIdentifierPrmrAltCommandPrimary(ctx *IdentifierPrmrAltCommandPrimaryContext) {
}

// EnterLiteralPrmrAltCommandPrimary is called when production literalPrmrAltCommandPrimary is entered.
func (s *BaseGroovyParserListener) EnterLiteralPrmrAltCommandPrimary(ctx *LiteralPrmrAltCommandPrimaryContext) {
}

// ExitLiteralPrmrAltCommandPrimary is called when production literalPrmrAltCommandPrimary is exited.
func (s *BaseGroovyParserListener) ExitLiteralPrmrAltCommandPrimary(ctx *LiteralPrmrAltCommandPrimaryContext) {
}

// EnterGstringPrmrAltCommandPrimary is called when production gstringPrmrAltCommandPrimary is entered.
func (s *BaseGroovyParserListener) EnterGstringPrmrAltCommandPrimary(ctx *GstringPrmrAltCommandPrimaryContext) {
}

// ExitGstringPrmrAltCommandPrimary is called when production gstringPrmrAltCommandPrimary is exited.
func (s *BaseGroovyParserListener) ExitGstringPrmrAltCommandPrimary(ctx *GstringPrmrAltCommandPrimaryContext) {
}
...
func (s *BaseGroovyParserListener) EnterMap(ctx *MapContext) {}

// ExitMap is called when production map is exited.
func (s *BaseGroovyParserListener) ExitMap(ctx *MapContext) {}
...
// EnterNamedPropertyArgList is called when production namedPropertyArgList is entered.
func (s *BaseGroovyParserListener) EnterNamedPropertyArgList(ctx *NamedPropertyArgListContext) {}

// ExitNamedPropertyArgList is called when production namedPropertyArgList is exited.
func (s *BaseGroovyParserListener) ExitNamedPropertyArgList(ctx *NamedPropertyArgListContext) {}
...
// EnterNamedPropertyArg is called when production namedPropertyArg is entered.
func (s *BaseGroovyParserListener) EnterNamedPropertyArg(ctx *NamedPropertyArgContext) {}

// ExitNamedPropertyArg is called when production namedPropertyArg is exited.
func (s *BaseGroovyParserListener) ExitNamedPropertyArg(ctx *NamedPropertyArgContext) {}

// EnterNamedArg is called when production namedArg is entered.
func (s *BaseGroovyParserListener) EnterNamedArg(ctx *NamedArgContext) {}

// ExitNamedArg is called when production namedArg is exited.
func (s *BaseGroovyParserListener) ExitNamedArg(ctx *NamedArgContext) {}
...
// EnterNamedPropertyArgLabel is called when production namedPropertyArgLabel is entered.
func (s *BaseGroovyParserListener) EnterNamedPropertyArgLabel(ctx *NamedPropertyArgLabelContext) {}

// ExitNamedPropertyArgLabel is called when production namedPropertyArgLabel is exited.
func (s *BaseGroovyParserListener) ExitNamedPropertyArgLabel(ctx *NamedPropertyArgLabelContext) {}

// EnterNamedArgLabel is called when production namedArgLabel is entered.
func (s *BaseGroovyParserListener) EnterNamedArgLabel(ctx *NamedArgLabelContext) {}

// ExitNamedArgLabel is called when production namedArgLabel is exited.
func (s *BaseGroovyParserListener) ExitNamedArgLabel(ctx *NamedArgLabelContext) {}
...
func (s *BaseGroovyParserListener) EnterDim(ctx *DimContext) {}

// ExitDim is called when production dim is exited.
func (s *BaseGroovyParserListener) ExitDim(ctx *DimContext) {}
...
// EnterEnhancedArgumentListInPar is called when production enhancedArgumentListInPar is entered.
func (s *BaseGroovyParserListener) EnterEnhancedArgumentListInPar(ctx *EnhancedArgumentListInParContext) {
}

// ExitEnhancedArgumentListInPar is called when production enhancedArgumentListInPar is exited.
func (s *BaseGroovyParserListener) ExitEnhancedArgumentListInPar(ctx *EnhancedArgumentListInParContext) {
}

// EnterFirstArgumentListElement is called when production firstArgumentListElement is entered.
func (s *BaseGroovyParserListener) EnterFirstArgumentListElement(ctx *FirstArgumentListElementContext) {
}

// ExitFirstArgumentListElement is called when production firstArgumentListElement is exited.
func (s *BaseGroovyParserListener) ExitFirstArgumentListElement(ctx *FirstArgumentListElementContext) {
}
